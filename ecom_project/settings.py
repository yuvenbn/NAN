...
#Media files
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # requires collectstatic command
MEDIA_URL = '/media/'
...
LOGOUT_REDIRECT_URL = 'home'  # doesn't require any html file.

# website url: https://https://ym-djecom.herokuapp.com/

EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'yuvenb5@gmail.com'
EMAIL_HOST_PASSWORD = 'jqoixmvqbxmvqinf'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
